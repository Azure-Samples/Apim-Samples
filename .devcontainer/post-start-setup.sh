...
echo "        --> Don't worry, it is expected that 'az login' failed."
echo ""
echo "   2. Wait until Codespace is ready (it's quick and may already be done!):"
...
echo ""
echo "   3. Open a new terminal and log in via the Azure CLI command above."
...
echo " Optional:"
echo ""
echo "   4. Launch the APIM Samples Developer CLI via 'bash start.sh'"
echo ""
echo "============================================================================"
echo -e "\n\n"
