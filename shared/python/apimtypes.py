...
REQUEST_HEADERS_XML_POLICY_PATH = str(
    _SHARED_XML_POLICY_BASE_PATH / "request-headers.xml"
)
...
class APIMNetworkMode(StrEnum):
    ...
    EXTERNAL_VNET = (
        "External"  # APIM is deployed in a VNet with external (public) access
    )
    INTERNAL_VNET = (
        "Internal"  # APIM is deployed in a VNet with only internal (private) access
    )
...
class INFRASTRUCTURE(StrEnum):
    ...
    AG_APIM_VNET = (
        "ag-apim-vnet"  # App Gateway in front of APIM with External VNet mode
    )
...
class API:  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(
        ...
        self.policyXml = (
            ...
            else _read_policy_xml(DEFAULT_XML_POLICY_PATH)
        )
    ...
    def to_dict(self) -> dict:
        """Return a serializable dictionary representation of the API."""
        ...
        return {
            ...
            "operations": (
                [op.to_dict() for op in self.operations] if self.operations else []
            ),
...
class APIOperation:
    ...
    def __init__(
        ...
        self.templateParameters = (
            templateParameters if templateParameters is not None else []
        )
    ...
    def to_dict(self) -> dict:
        """Return a serializable dictionary representation of the API operation."""
...
class GET_APIOperation(APIOperation):
    ...
    def __init__(
        ...
        super().__init__(
            "GET", "GET", "/", HTTP_VERB.GET, description, policyXml, templateParameters
        )
...
class NamedValue:
    ...
    def to_dict(self) -> dict:
        """Return a serializable dictionary representation of the named value."""

        return {"name": self.name, "value": self.value, "isSecret": self.isSecret}
...
class PolicyFragment:
    ...
    def to_dict(self) -> dict:
        """Return a serializable dictionary representation of the policy fragment."""
...
class Product:
    ...
    def to_dict(self) -> dict:
        """Return a serializable dictionary representation of the product."""
