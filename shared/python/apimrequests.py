...
# TODO: Consider creating a base class or modify the constructor to suit all points of entry
...
class ApimRequests2:
    """
    Methods for making requests to the Azure API Management service, including from a secure App Gateway
    Provides single and multiple request helpers with consistent logging.
    """
    ...
    def __init__(self, host: str, ip: str, apimSubscriptionKey: str | None = None) -> None:
        """
        Initialize the ApimRequests object.

        Args:
            host: The host to add to the Host header
            ip: The IP to target with the request
            apimSubscriptionKey: Optional subscription key for APIM.
        """
