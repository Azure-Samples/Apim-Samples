...
resource apimService 'Microsoft.ApiManagement/service@2024-06-01-preview' = {
  ...
  properties: union({
    ...
    // Policy: API Management minimum API version should be set to 2019-12-01 or higher
    apiVersionConstraint: {
      minApiVersion: '2019-12-01'
    }
    // Policy: API Management should disable public network access to the service configuration endpoints
    disableGateway: false
    // Disable public access to service configuration endpoints
