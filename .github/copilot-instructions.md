...
- Avoid unused variables for functions that return tuples by assigning to `_` if the variable is not needed. Example for not using var2:
    
    ```python
    var1, _, var3 = some_function()
    ```
