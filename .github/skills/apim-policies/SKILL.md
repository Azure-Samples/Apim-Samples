...
Do not add policy tooling or package installation that bypasses the repository's eight-day release waiting period. Use the locked dependency workflow and verify release ages before running new tooling.
