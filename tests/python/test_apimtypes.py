...
def test_api_missing_fields():
    ...
    with pytest.raises(TypeError):
        apimtypes.API(displayName=EXAMPLE_DISPLAY_NAME, path=EXAMPLE_PATH, description=EXAMPLE_DESCRIPTION, policyXml=EXAMPLE_POLICY_XML)  # pylint: disable=no-value-for-parameter

    with pytest.raises(TypeError):
        apimtypes.API(name=EXAMPLE_NAME, path=EXAMPLE_PATH, description=EXAMPLE_DESCRIPTION, policyXml=EXAMPLE_POLICY_XML)  # pylint: disable=no-value-for-parameter

    with pytest.raises(TypeError):
        apimtypes.API(name=EXAMPLE_NAME, displayName=EXAMPLE_DISPLAY_NAME, description=EXAMPLE_DESCRIPTION, policyXml=EXAMPLE_POLICY_XML)  # pylint: disable=no-value-for-parameter

    with pytest.raises(TypeError):
        apimtypes.API(name=EXAMPLE_NAME, displayName=EXAMPLE_DISPLAY_NAME, path=EXAMPLE_PATH, policyXml=EXAMPLE_POLICY_XML)  # pylint: disable=no-value-for-parameter
...
def test_product_repr_additional():
    """Additional Product __repr__ test to avoid duplicate function name."""
