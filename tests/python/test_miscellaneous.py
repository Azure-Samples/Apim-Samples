...
#     check_python.sh scripts properly detect and highlight slow tests (>0.2s).

#     The test is intentionally commented out as to not pollute the test results.

#     The pytest durations output should show this test taking >0.2s, and the
#     check scripts should display a yellow warning message with guidance to review
#     slowest durations in the test summary.
#     """
#     time.sleep(0.25)  # Sleep 250ms to exceed 0.2s threshold
#     assert True
